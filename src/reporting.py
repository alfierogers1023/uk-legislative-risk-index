...
from src.data_clients.members_client import COMMONS, get_all_members
...
def build_monthly_cohesion_table(party, majority_size, months_of_history):
    """
    ...
    Returns:
        pandas.DataFrame with columns: month, rebellion_rate,
